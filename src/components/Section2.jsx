...
const Section2 = () => {
  ...
  return (
    <div className="section2Wrap">
      <Wrap>
        <h1 className="text-center text-[25px]">Blog Section 2</h1>
        <p className="text-gray-500 text-center my-[20px]">
                ...
                array.map((item)=>{
                    return <div className="bg-[white] px-[30px] py-[30px] rounded-lg flex flex-col gap-[15px]">
                        ...
                        <div className="flex flex-row gap-[10px] items-center">
                            <Image src={item?.userImage} className="h-[40px] w-[40px] rounded-full"/>
                            <div>
                        ...
                        <div className="bg-blue-600 flex flex-row items-center gap-[10px] h-[40px] w-[120px] text-white p-[5px] rounded-lg cursor-pointer text-[13px]">
                            <p>Read more</p>
                            <AiOutlineRight/>
                        </div>
                    </div>
